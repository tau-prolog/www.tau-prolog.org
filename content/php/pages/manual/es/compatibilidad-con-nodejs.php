<div class="white container-fluid py-5">
    <div class="container">
		<h1>Compatibilidad con Node.js</h1>
...
<div class="white container-fluid py-5">
    <div class="container">
		<h2 id="importar"><a href="#importar">Importar la biblioteca</a></h2>
		...
		<h2 id="modulos" class="mt-5"><a href="#modulos">Cargar módulos</a></h2>
...
require( "./path/to/tau-prolog/random.js" )( pl );</code></pre>
		...
		<h2 id="ejemplo" class="mt-5"><a href="#ejemplo">Ejemplo de uso</a></h2>
