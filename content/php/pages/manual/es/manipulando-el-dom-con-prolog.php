<div class="white container-fluid py-5">
    <div class="container">
		<h1>Manipulando el DOM con Prolog</h1>
...
<div class="white container-fluid py-5">
    <div class="container">
		<h2 id="selectores"><a href="#selectores">Selectores</a></h2>
...
session.answer(); // {Output/&lt;html>(output), Body/&lt;html>(body), Event/&lt;event>(keypress)}</code></pre>
		...
		<h2 id="efectos" class="mt-5"><a href="#efectos">Efectos</a></h2>
