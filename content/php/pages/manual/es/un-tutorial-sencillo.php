<div class="white container-fluid py-5">
    <div class="container">
		<h1>Un tutorial sencillo</h1>
	</div>
</div>

<div class="white container-fluid py-5">
    <div class="container">
		<h2 id="que-es"><a href="#que-es">¿Qué es Tau Prolog?</a></h2>
		...
		<h2 id="instalacion" class="mt-5"><a href="#instalacion">Instalación</a></h2>
...
...</code></pre>
		...
		<h2 id="cargar" class="mt-5"><a href="#cargar">Cargar programas y módulos</a></h2>
...
"); // true</code></pre>
	...
	console.log( parsed ); // throw(error(syntax_error(line(8), column(1), found(fruits_in), cause('. or expression expected'))))
		...
		<h2 id="consultar" class="mt-5"><a href="#consultar">Consultar objetivos</a></h2>
