...
<div class="white container-fluid py-5">
    <div class="container">
        <h2 id="what-is"><a href="#what-is">What is Tau Prolog?</a></h2>
        ...
        <h2 id="installation" class="mt-5"><a href="#installation">Installation</a></h2>
...
...</code></pre>
        ...
        <h2 id="load" class="mt-5"><a href="#load">Load programs and modules</a></h2>
...
"); // true</code></pre>
    ...
    console.log( parsed ); // throw(error(syntax_error(line(8), column(1), found(fruits_in), cause('. or expression expected'))))
        ...
        <h2 id="query" class="mt-5"><a href="#query">Queries and goals</a></h2>
        ...
        <p>Once the goal has been added to the pile, the <span class="inline-code">answer</span> method in <span class="inline-code">pl.type.Session</span> allows us to look for answers (facts or rules) which make the goal true. Tau Prolog is <strong>asynchronous</strong>, which means that <span class="inline-code">answer</span> will not return the results, but call a callback function if it finds something. This feature gives the Prolog predicates the ability to make asynchronous operations, as sleeping the execution or to make Ajax queries <span class="manual-annotation">(see <a href="/manual/making-your-own-packages#async-predicates">[Making your own packages] #Definition of asynchronous predicates</a> from Tau Prolog manual)</span>. In this case, the callback is given to <span class="inline-code">answer</span> as an argument. If no callback is passed, <span class="inline-code">console.log</span> will be called.</p>
