<div class="white container-fluid py-5">
    <div class="container">
		<h1>Compatibility with Node.js</h1>
...
<div class="white container-fluid py-5">
	...
	<h2 id="import"><a href="#import">Importing the library</a></h2>
	...
	<h2 id="modules" class="mt-5"><a href="#modules">Loading modules</a></h2>
...
require( "./path/to/tau-prolog/random.js" )( pl );</code></pre>
	...
	<h2 id="example" class="mt-5"><a href="#example">Example</a></h2>
